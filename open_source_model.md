...
In terms of reproducibility, using open‑source models improves reproducibility by allowing fixed model versions, deterministic decoding settings, and offline evaluation without API drift. Model updates and settings can be more opaque for closed sourced models. 
